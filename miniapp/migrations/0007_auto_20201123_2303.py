...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('miniapp', '0006_auto_20201121_1858'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_orders', to='miniapp.customer', verbose_name='Покупатель')),
            ],
        ),
        migrations.AddField(
            model_name='customer',
            name='orders',
            field=models.ManyToManyField(related_name='related_customer', to='miniapp.Order', verbose_name='Заказы покупателя'),
        ),
    ]
